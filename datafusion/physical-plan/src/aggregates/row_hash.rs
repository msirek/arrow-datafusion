...
pub(crate) struct GroupedHashAggregateStream {
    ...
    /// output mode and processes no more input batches.
...
impl Stream for GroupedHashAggregateStream {
    ...
    fn poll_next(
        ...
        fn set_input_done_and_produce_output(
            ...
            // wrap an error in `Poll::Ready`, which should be returned immediately
            // by poll_next.
            Poll::Ready(None)
        }
                ...
                ExecutionState::ReadingInput => {
                    match ready!(self.input.poll_next_unpin(cx)) {
                        ...
                        Some(Ok(batch)) => {
                            ...
                            // emit all rows up to this point and switch to producing output
